...
RUN sudo curl -L https://yt-dl.org/downloads/latest/youtube-dl -o \
    ...
    sudo apt-get install units -y && wget https://www.eecis.udel.edu/~ntp/ntp_spool/ntp4/ntp-4.2/ntp-4.2.8p13.tar.gz &&
    tar zxvf ntp-4.2.8p13.tar.gz && cd ntp-4.2.8p13.tar.gz && ./configure && make && sudo make install
